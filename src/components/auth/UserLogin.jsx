...
import { User, Phone, Lock, ArrowLeft, ArrowRight, Stethoscope, CheckCircle2, KeyRound, ShieldCheck } from 'lucide-react';
...
export default function UserLogin({ onGoBack, onBackToPortals, onGoToRegister, onGoToHospitalLogin, onGoToAdminLogin }) {
  ...
  return (
    <div className="min-h-[calc(100vh-65px)] flex-1 flex flex-col md:flex-row items-stretch w-full bg-white">
      ...
      {/* ═══ LEFT BRANDING PANEL (Cyberpunk Medical Gradient - Edge to Edge) ═══ */}
      <div className="hidden md:flex flex-col justify-between w-[440px] lg:w-[480px] flex-shrink-0 bg-gradient-to-br from-slate-900 via-cyan-950/40 to-slate-900 border-r border-slate-800/80 p-10 lg:p-14 relative overflow-hidden">
        <div className="absolute top-0 left-0 w-80 h-80 bg-cyan-500/10 rounded-full blur-3xl pointer-events-none -z-10"></div>
        <div className="absolute bottom-0 right-0 w-80 h-80 bg-blue-500/10 rounded-full blur-3xl pointer-events-none -z-10"></div>
        ...
        <div className="relative z-10">
          <div className="flex items-center gap-3.5 mb-10">
            ...
            <div>
              ...
              <span className="text-[11px] font-bold text-cyan-400 uppercase tracking-wider">Patient Portal</span>
            </div>
          </div>
          ...
          <p className="text-slate-300 text-xs lg:text-sm leading-relaxed">
            Access your digital OP tokens, check live doctor consultation availability in real-time, and download verified digital receipts.
          </p>
        </div>
        ...
        <div className="text-[11px] text-slate-400 border-t border-slate-800/80 pt-4 relative z-10 flex items-center gap-2">
          ...
          <span>NABH Verified · 256-Bit Encrypted Healthcare Security</span>
        </div>
      </div>
      ...
      <div className="flex-1 flex flex-col justify-center items-center p-6 sm:p-12 lg:p-16 bg-slate-950/80 relative">
        <div className="w-full max-w-md lg:max-w-lg space-y-6">
          ...
          <div className="space-y-2">
            ...
            <p className="text-xs sm:text-sm text-slate-400">Enter your 10-digit mobile number and password to sign in.</p>
          </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full bg-slate-900/90 border border-slate-800 focus:border-cyan-500/60 rounded-xl pl-10 pr-4 py-3.5 text-sm text-white outline-none transition-colors"
                  required
                />
              </div>
            </div>
          ...
          <div className="pt-4 border-t border-slate-800/80">
            <div className="bg-cyan-950/40 p-4 rounded-2xl border border-cyan-500/30 flex flex-col sm:flex-row items-center justify-between gap-3 shadow-lg">
              ...
              <div className="flex items-center gap-2 w-full sm:w-auto">
                ...
                <button
                  ...
                  className="flex-1 sm:flex-none px-4 py-2 bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-400 hover:to-blue-500 text-white rounded-xl text-xs font-bold shadow-md cursor-pointer transition-all active:scale-95 flex items-center justify-center gap-1"
