  ...
  return (
    <div className="min-h-[calc(100vh-140px)] flex items-center justify-center p-3 sm:p-6 lg:p-10 w-full">
      <div className="w-full max-w-4xl glass-panel rounded-3xl border border-slate-800/90 shadow-2xl overflow-hidden flex flex-col md:flex-row items-stretch">
        ...
        {/* ═══ LEFT BRANDING PANEL (Indigo & Royal Purple SaaS) ═══ */}
        <div className="hidden md:flex flex-col justify-between w-[380px] flex-shrink-0 bg-gradient-to-br from-slate-900 via-indigo-950/40 to-slate-900 border-r border-slate-800 p-8 sm:p-10 relative overflow-hidden">
          <div className="absolute top-0 left-0 w-64 h-64 bg-indigo-500/10 rounded-full blur-3xl pointer-events-none -z-10"></div>
          <div className="absolute bottom-0 right-0 w-64 h-64 bg-purple-500/10 rounded-full blur-3xl pointer-events-none -z-10"></div>
        ...
        <div className="flex-1 p-6 sm:p-10 flex flex-col justify-between bg-slate-950/40">
          ...
          <div>
            ...
            <div className="mb-6 space-y-1.5">
              <div className="w-11 h-11 rounded-2xl bg-indigo-500/10 border border-indigo-500/30 flex items-center justify-center mb-3 text-indigo-400 shadow-md">
                <ShieldCheck className="w-5 h-5" />
              </div>
              <h2 className="text-2xl font-extrabold text-white font-outfit">Super Admin Login</h2>
              <p className="text-xs text-slate-400">Master Control Portal — Restricted Authority Access Only.</p>
            </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full bg-slate-900/90 border border-slate-800 focus:border-indigo-500/60 rounded-xl pl-10 pr-4 py-3 text-sm text-white outline-none transition-colors"
                    required
                  />
                </div>
              </div>
          ...
          <div className="mt-6 pt-4 border-t border-slate-800/80">
            <div className="bg-indigo-950/40 p-3.5 rounded-2xl border border-indigo-500/30 flex flex-col sm:flex-row items-center justify-between gap-2.5 shadow-lg">
