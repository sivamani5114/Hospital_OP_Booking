  ...
  return (
    <div className="min-h-[calc(100vh-65px)] flex-1 flex flex-col md:flex-row items-stretch w-full bg-slate-950">
      ...
      <div className="hidden md:flex flex-col justify-between w-[440px] lg:w-[480px] flex-shrink-0 bg-gradient-to-br from-slate-900 via-emerald-950/40 to-slate-900 border-r border-slate-800/80 p-10 lg:p-14 relative overflow-hidden">
        <div className="absolute top-0 left-0 w-80 h-80 bg-emerald-500/10 rounded-full blur-3xl pointer-events-none -z-10"></div>
        <div className="absolute bottom-0 right-0 w-80 h-80 bg-teal-500/10 rounded-full blur-3xl pointer-events-none -z-10"></div>
        ...
        <div className="relative z-10">
          <div className="flex items-center gap-3.5 mb-10">
            ...
            <div>
              ...
              <span className="text-[11px] font-bold text-emerald-400 uppercase tracking-wider">Hospital Desk</span>
            </div>
          </div>
        ...
        <div className="text-[11px] text-slate-400 border-t border-slate-800/80 pt-4 relative z-10 flex items-center gap-2">
          ...
          <span>CEA Compliant · Encrypted Hospital Desk Management</span>
        </div>
      </div>
      ...
      <div className="flex-1 flex flex-col justify-center items-center p-6 sm:p-12 lg:p-16 bg-slate-950/80 relative">
        <div className="w-full max-w-md lg:max-w-lg space-y-6">
          ...
          <div className="space-y-2">
            ...
            <p className="text-xs sm:text-sm text-slate-400">OP Consultation Desk & Reception Management Portal</p>
          </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full bg-slate-900/90 border border-slate-800 focus:border-emerald-500/60 rounded-xl pl-10 pr-4 py-3.5 text-sm text-white outline-none transition-colors"
                  required
                />
              </div>
            </div>
          ...
          <div className="pt-4 border-t border-slate-800/80">
            <div className="bg-emerald-950/40 p-4 rounded-2xl border border-emerald-500/30 flex flex-col sm:flex-row items-center justify-between gap-3 shadow-lg">
              ...
              <div className="flex items-center gap-2 w-full sm:w-auto">
                ...
                <button
                  ...
                  className="flex-1 sm:flex-none px-4 py-2 bg-gradient-to-r from-emerald-600 to-teal-600 hover:from-emerald-500 hover:to-teal-500 text-white rounded-xl text-xs font-bold shadow-md cursor-pointer transition-all active:scale-95 flex items-center justify-center gap-1"
